            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6">
                {contactInfo.map((info, index) => (
                  <Card 
                    key={index} 
                    className="border-0 bg-gradient-secondary hover:shadow-lg transition-shadow duration-300 animate-fade-in"
              ...
              {/* Map placeholder */}
              <Card className="border-0 bg-gradient-secondary animate-fade-in" style={{ animationDelay: '0.4s' }}>
